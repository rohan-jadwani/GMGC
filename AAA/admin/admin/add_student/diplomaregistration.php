							...
							<div class="col-md-12">
								<div class="card mb-3">
									<div class="card-header">
										<i class="fas fa-fw fa fa-user"></i> Diploma Student Registration
									</div>
									<div class="card-body">
										<form method="POST" action="" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												<div class="form-row">
													<label class="col-md-4 control-label">
														<h4 style="color: green" ;align="left">10th Result Details </h4>
													</label>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="form-row">
													<label class="col-sm-2 control-label">10th Medium : </label>
													<div class="col-sm-10">
														<select name="stu_10th_medium" id="stu_10th_medium" class="form-control">
