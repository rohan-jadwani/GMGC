...
$cmd = "SELECT * FROM branch_cor WHERE id='$id'";
		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Edit Branch Co-ordinator</li>
				</ol>
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						$query1 = "SELECT bname FROM branch WHERE bname!='$bname'";
						...
						<form method="post" class="form-horizontal" action="./edit.php">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="f_name" id="f_name" value="<?php echo $f_name; ?>" required="required">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" maxlength="10" class="form-control" name="mobile" id="mobile" value="<?php echo $mobile; ?>" required="required">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">Password</label>
								<div class="col-sm-8">
									<input type="password" class="form-control" name="password" id="password" value="<?php echo $password; ?>" required="required">
									<i class="far fa-eye" onclick="pwvisible()" style="float: right; position:relative; top:-25px; left:-10px;"></i>
								</div>
							</div>

							<div class="col-sm-8 col-sm-offset-2">
								<input class="btn btn-primary" type="submit" name="submit" value="Update Branch-Coordinator ">
							</div>
					</div>
