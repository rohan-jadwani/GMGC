        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Attempt certificate</li>
                </ol>

                <!-- Icon Cards-->
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-fw fa fa-desktop"></i> Attempt certificate
                    </div>
                    ...
                    <div class="card-body">
                        <table id="zctb" class="display table table-striped table-bordered table-hover table-responsive" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $cmd = "SELECT * FROM `attempt_certificate`";
                                $sno = 0;
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <img src="<?php echo "../../../AAA/gmgc/gmgc/student_portal/certificates/attempt_image/". $id_proof; ?>" width="100px" alt="Image">
                                            <a href="<?php echo "../../../AAA/gmgc/gmgc/student_portal/certificates/attempt_image/" . $id_proof; ?>" target="_blank">View Image</a>
                                        </td>
                                        <td style="text-align: center;">
                                            ...
                                            <a href="<?php echo "../../../AAA/gmgc/gmgc/student_portal/certificates/attempt_image/" . $provisional; ?>" target="_blank">View Document</a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <form action="./certificate/attempt.php">
                                            <button  class="btn btn-primary" id="button3" style="visibility: visible;">Download</button>
                                            </form>
                                            <?php }else{?>
                                            
                                            <a href="./update_certificate_status/attempt_status.php" name="approved" title="Edit Record"><i class="fa fa-user-check"></i></a>
                                            &nbsp;
                                            <a href="./delete/attempt_delete.php" title="Delete Record" name="delete" onclick="return confirm('Do you want to delete');"><i class="fa fa-user-times"></i></a>
