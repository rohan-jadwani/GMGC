            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-fw fa fa-desktop"></i> Bonafide certificate
                    </div>
                    ...
                    <div class="card-body">
                        <table id="zctb" class="display table table-striped table-bordered table-hover table-responsive" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $cmd = "SELECT * FROM `bonafide_certificate`";
                                $sno = 0;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <img src="<?php echo "../../../AAA/gmgc/gmgc/student_portal/certificates/bonafide_image/" . $img; ?>" width="100px" alt="Image">
                                            <a href="<?php echo "../../../AAA/gmgc/gmgc/student_portal/certificates/bonafide_image/" . $img; ?>" target="_blank">View Image</a>
                                        </td>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a href="<?php echo "../../../AAA/gmgc/gmgc/student_portal/certificates/bonafide_image/" . $sign; ?>" target="_blank">View Document</a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <form action="./certificate/bonafide.php?enrollment=<?php echo $er_no; ?>">
                                            <button  class="btn btn-primary" id="button3" style="visibility: visible;">Download</button>
                                            </form>
                                            <?php }else{?>
                                            
                                            <a href="./update_certificate_status/bonafide_status.php?enrollment=<?php echo $er_no; ?>" name="approved" title="Edit Record"><i class="fa fa-user-check"></i></a>
                                            &nbsp;
                                            <a href="./delete/bonafide_delete.php" title="Delete Record" name="delete" onclick="return confirm('Do you want to delete');"><i class="fa fa-user-times"></i></a>
