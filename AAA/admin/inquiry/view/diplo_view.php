        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">View Diploma Student Details</li>
                </ol>
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-fw fa-table"></i> View Diploma Student Details
                    </div>
                                ...
                                <div class="tab-pane active" id="inquiry-attr" role="tabpanel" aria-labelledby="inquiry-tab-attr">
                                    <div class="card-body" style="margin-top: 20px;">
                                        <div class="table-responsive">
                                            ...
                                            $cmd = "SELECT * FROM diplo_inquiry WHERE email='$email'";
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="load" class="table table-striped table-bordered zero-configuration" align="center" style="width:90%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td> Student Image </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/diplo_images/" . $s_image; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Student Sign</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/diplo_images/" . $s_sign; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td> Student Aadharcard </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/diplo_images/" . $s_aadhar; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td> Student Leaving Certificate </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/diplo_images/" . $s_leaving; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Bank Passbook</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/diplo_images/" . $bank_pb; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Cast Certificate</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/diplo_images/" . $s_cast; ?>" width="100px" alt="Image"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>Income Certificate</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/diplo_images/" . $s_income; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>SSC Marksheet</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/diplo_images/" . $ssc_i; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                ...
                                <div class="tab-pane" id="other-attr" role="tabpanel" aria-labelledby="other-tab-attr">
                                    <div class="card-body" style="margin-top: 20px;">
                                        <div class="table-responsive">
                                            ...
                                            while ($rows = mysqli_fetch_array($result)) {
                                                $email = $rows['email'];
                                                $acpdc_meritno = $rows['acpc_meritno'];
                                                $acpdc_meritmark = $rows['acpc_meritmark'];
                                            ...
                                            <table id="load" class="table table-striped table-bordered zero-configuration" align="center" style="width:90%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td> ACPC Merit No. </td>
                                                        <td><?php echo $acpdc_meritno; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>ACPC Merit Mark</td>
                                                        <td><?php echo $acpdc_meritmark; ?></td>
                                                    </tr>
                                                    <tr>
