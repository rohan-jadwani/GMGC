        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">View Post Graduation Student Details</li>
                </ol>
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-fw fa-table"></i> View Post Graduation Student Details
                    </div>
                                ...
                                <div class="tab-pane active" id="inquiry-attr" role="tabpanel" aria-labelledby="inquiry-tab-attr">
                                    <div class="card-body" style="margin-top: 20px;">
                                        <div class="table-responsive">
                                            ...
                                            $cmd = "SELECT * FROM pg_inquiry WHERE email='$email'";
                                            ...
                                            while ($rows = mysqli_fetch_array($result)) {
                                                ...
                                                $dob = $rows['dob'];
                                                $bsc_pr = $rows['bsc_pr'];
                                                $bsc_main_sub = $rows['bsc_main_sub'];
                                                $bsc_p_year = $rows['bsc_p_year'];
                                                $email = $rows['email'];
                                            }
                                            // }
                                            ?>
                                            <table id="load" class="table table-striped table-bordered zero-configuration" align="center" style="width:90%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>BSC pr%</td>
                                                        <td><?php echo $bsc_pr; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>BSC Main Sub</td>
                                                        <td><?php echo  $bsc_main_sub; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>BSC Passing Year </td>
                                                        <td><?php echo $bsc_p_year; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Email Address</td>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="load" class="table table-striped table-bordered zero-configuration" align="center" style="width:90%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td> Student Image </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/pg_images/" . $s_image; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Student Sign</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/pg_images/" . $s_sign; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td> Student Aadharcard </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/pg_images/" . $s_aadhar; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td> Student Leaving Certificate </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/pg_images/" . $s_leaving; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Bank Passbook</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/pg_images/" . $bank_pb; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Cast Certificate</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/pg_images/" . $s_cast; ?>" width="100px" alt="Image"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>Income Certificate</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/pg_images/" . $s_income; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>BSC Marksheet (Provisional)</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/pg_images/" . $bsc_pro; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                    ...
                                    <div class="card-body" style="margin-top: 20px;">
                                        <div class="table-responsive">
                                            ...
                                            while ($rows = mysqli_fetch_array($result)) {
                                                ...
                                                $board = $rows['board'];
                                                $bsc_sem1 = $rows['bsc_sem1'];
                                                $bsc_sem2 = $rows['bsc_sem2'];
                                                $bsc_sem3 = $rows['bsc_sem3'];
                                                $bsc_sem4 = $rows['bsc_sem4'];
                                                $bsc_sem5 = $rows['bsc_sem5'];
                                                $bsc_sem6 = $rows['bsc_sem6'];
                                            }
                                            ...
                                            <table id="load" class="table table-striped table-bordered zero-configuration" align="center" style="width:90%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>BSC Sem 1</td>
                                                        <td><?php echo $bsc_sem1; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>BSC Sem 2</td>
                                                        <td><?php echo $bsc_sem2; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>BSC Sem 3</td>
                                                        <td><?php echo $bsc_sem3; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>BSC Sem 4 </td>
                                                        <td><?php echo  $bsc_sem4; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>BSC Sem 5 </td>
                                                        <td><?php echo $bsc_sem5; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>BSC Sem 6</td>
                                                        <td><?php echo $bsc_sem6; ?></td>
                                                    </tr>
