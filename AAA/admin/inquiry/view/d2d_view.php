        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">View D2D Student Details</li>
                </ol>
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-fw fa-table"></i> View D2D Student Details
                    </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            ?> <table id="load" class="table table-striped table-bordered zero-configuration" align="center" style="width:90%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td> Student Image </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/d2d_images/" . $s_image; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Student Sign</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/d2d_images/" . $s_sign; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td> Student Aadharcard </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/d2d_images/" . $s_aadhar; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td> Student Leaving Certificate </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/d2d_images/" . $s_leaving; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Bank Passbook</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/d2d_images/" . $bank_pb; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Cast Certificate</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/d2d_images/" . $s_cast; ?>" width="100px" alt="Image"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>Income Certificate</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/d2d_images/" . $s_income; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>SSC Marksheet</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/d2d_images/" . $ssc_i; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Diplo Provisional</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/d2d_images/" . $diplo_pro; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="load" class="table table-striped table-bordered zero-configuration" align="center" style="width:90%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td> ACPDC Merit No. </td>
                                                        <td><?php echo $acpc_meritno; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>ACPDC Merit Mark</td>
