        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">View MCA Student Details</li>
                </ol>
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-fw fa-table"></i> View MCA Student Details
                    </div>
                                ...
                                <div class="tab-pane active" id="inquiry-attr" role="tabpanel" aria-labelledby="inquiry-tab-attr">
                                    <div class="card-body" style="margin-top: 20px;">
                                        <div class="table-responsive">
                                            <?php
                                            // $con = mysqli_connect('localhost','root','','gmgc','3308');
                                            include '../../../includes/config.php';
                                            // if (isset($_POST['view'])) {
                                            $email = $_GET['email'];
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="load" class="table table-striped table-bordered zero-configuration" align="center" style="width:90%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td> Student Image </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $s_image; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Student Sign</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $s_sign; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td> Student Aadharcard </td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $s_aadhar; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td> Student Leaving Certificate </td>
                                                        <td>
                                                            <img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $s_leaving; ?>" width="100px" alt="Image">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Bank Passbook</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $bank_pb; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Cast Certificate</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $s_cast; ?>" width="100px" alt="Image"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>Income Certificate</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $s_income; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>SSC Marksheet</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $ssc_i; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>HSC Marksheet</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $hsc_i; ?>" width="100px" alt="Image"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>BCA Sem-1 Marksheet</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $g_sem1; ?>" width="100px" alt="Image"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>BCA Sem-2 Marksheet</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $g_sem2; ?>" width="100px" alt="Image"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>BCA Sem-3 Marksheet</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $g_sem3; ?>" width="100px" alt="Image"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>BCA Sem-4 Marksheet</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $g_sem4; ?>" width="100px" alt="Image"></td>
                                                    </tr>

                                                    <tr>
                                                        <td>BCA Sem-5 Marksheet</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $g_sem5; ?>" width="100px" alt="Image"></td>
                                                    </tr>

                                                    <tr>

                                                        <td>BCA Sem-6 Marksheet</td>
                                                        <td><img src="<?php echo "../../../gmgc_student/document_upload/upload-images/mca_images/" . $g_sem6; ?>" width="100px" alt="Image"></td>
                                                    </tr>
