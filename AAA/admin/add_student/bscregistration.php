							...
							<div class="col-md-12">
								<div class="card mb-3">
									<div class="card-header">
										<i class="fas fa-fw fa fa-user"></i> BSC Student Registration
									</div>
									<div class="card-body">
										<form method="POST" action="" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												<div class="form-row">
													<label class="col-md-2 control-label">Primary Subject : </label>
													<div class="col-md-10">
														<input type="text" name="stu_pri_sub" id="stu_pri_sub" placeholder="Please Enter Primary Subject Here" class="form-control" required="required">
													</div>
												</div>
											</div>
											<div class="form-group">
												<div class="form-row">
													<label class="col-md-2 control-label">Subsidary Subject : </label>
													<div class="col-md-10">
														<input type="text" name="stu_sub_sub" id="stu_sub_sub" placeholder="Please Enter Subsidary Subject Here" class="form-control" required="required">
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="form-row">
													...
													<div class="col-sm-10">
														<input type="text" name="stu_bio_mark" id="stu_bio_mark" class="form-control" placeholder="Please Enter Biology CGPA Here">
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												<div class="form-row">
													...
													<div class="col-sm-10">
														<select name="stu_12th_medium" id="stu_12th_medium" class="form-control">
