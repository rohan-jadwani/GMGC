<?php
// $cn = mysqli_connect("localhost", "root", "", "gmgc", "3308");
...
if (isset($_POST['submit'])) {
	...
	$h = $_POST['stu_issueby'];
	$i = $_POST['stu_serial'];
	$sql_a = "SELECT * FROM bonafied WHERE Stu_Enrollment='$a'";

	$res_u = mysqli_query($cn, $sql_a);


	if (mysqli_num_rows($res_u) > 0) {
		echo "<script>alert('MYSY Already Generated');</script>";
	} else {

		$cmd = "insert into mysy(Sr_no,Stu_Enrollment,Stu_Sem,Stu_Fname,Stu_Mname,Stu_Lname,Stu_Branch,Stu_Issue_Date,Stu_Issue_By,Stu_Serial) values('','$a','$b','$c','$d','$e','$f','$g','$h','$i') ";
		$run = mysqli_query($cn, $cmd);
		if (!$run) {
			echo "<script>alert('Error In Data Insert Or Somthing Went Wrong);";
		} else {
			echo "<script>alert('MYSY Added Successfully');</script>";
			echo "<script>location.href='mysy.php';</script>";
		}
	}
}
?>
		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Add Digital Gujarat Scholarship</li>
				</ol>

				<!-- Icon Cards-->
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-fw fa-fa fa-bookmark"></i>Add Digital Gujarat Scholarship detail
					</div>
					...
					<div class="card-body">
						<form method="post" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select name="stu_sem" class="form-control" required="required">
										<option value="">Select Semester</option>
										<option value="sem1">Sem-01</option>
										<option value="sem2">Sem-02</option>
										<option value="sem3">Sem-03</option>
										<option value="sem4">Sem-04</option>
										<option value="sem5">Sem-05</option>
										<option value="sem6">Sem-06</option>
										<option value="sem7">Sem-07</option>
										<option value="sem8">Sem-08</option>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="date" name="stu_isudate" id="stu_isudate" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="stu_issueby" id="stu_issueby" class="form-control" placeholder="Please Enter Issue By Name Here">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="stu_serial" id="stu_serial" class="form-control" placeholder="Eg. - 01">
								</div>
							</div>

							<div class="col-sm-8 col-sm-offset-2">
								<input class="btn btn-primary" type="submit" name="submit" value="Add Certificate">
							</div>
					</div>
