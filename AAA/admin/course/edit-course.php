...
$cmd = "SELECT * FROM course WHERE id ='$id'";
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-fw fa-folder"></i> Edit Courses detail
					</div>
					...
					<div class="card-body">
						<form method="post" class="form-horizontal" action="./edit.php">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" value="<?php echo $coursecode; ?>" name="coursecode" placeholder="BE129 or B.Sc129" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label">Course Name (Short)</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="course_sn" id="cns" value="<?php echo $course_sn; ?>" placeholder="BE or B.Sc" required="required">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="course_fn" value="<?php echo $course_fn; ?>" placeholder="Bachelor of Engineering">
								</div>
							</div>
